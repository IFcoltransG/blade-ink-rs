...
impl Choice {
    pub(crate) fn new(
        ...
        Self {
            ...
            tags,
            index: Mutex::new(0),
            original_thread_index: Mutex::new(0),
            text,
            thread_at_generation: Mutex::new(Some(thread_at_generation)),
            source_path,
        }
    }
    ...
    pub(crate) fn new_from_json(
        ...
        Choice {
            ...
            original_thread_index: Mutex::new(original_thread_index),
            text: text.to_string(),
            thread_at_generation: Mutex::new(None),
            source_path,
        }
    }
