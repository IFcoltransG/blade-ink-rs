...
pub struct Choice {
    obj: Object,
    thread_at_generation: RwLock<Option<Thread>>,
    pub(crate) original_thread_index: RwLock<usize>,
...
impl Choice {
    pub(crate) fn new(
        ...
        Self {
            ...
            tags,
            index: RwLock::new(0),
            original_thread_index: RwLock::new(0),
            text,
            thread_at_generation: RwLock::new(Some(thread_at_generation)),
            source_path,
        }
    }
    ...
    pub(crate) fn new_from_json(
        ...
        Choice {
            ...
            original_thread_index: RwLock::new(original_thread_index),
            text: text.to_string(),
            thread_at_generation: RwLock::new(None),
            source_path,
        }
    }

    pub(crate) fn set_thread_at_generation(&self, thread: Thread) {
        *self.thread_at_generation.write().unwrap() = Some(thread);
    }
