...
use std::{sync::RwLock, collections::HashMap, sync::Arc};
...
pub struct Story {
    ...
    pub(crate) on_error: Option<Arc<RwLock<dyn ErrorHandler>>>,
    pub(crate) state_snapshot_at_last_new_line: Option<StoryState>,
    pub(crate) variable_observers: HashMap<String, Vec<Arc<RwLock<dyn VariableObserver>>>>,
